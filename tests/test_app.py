...
class CalculateApiTest(unittest.TestCase):
    ...
    def test_current_views_do_not_render_footer_phases_or_history(self):
        ...
        self.assertIn('value="0.001"', calculator_html)
        self.assertIn('value="100"', calculator_html)
        ...
        self.assertIn('toleranceInput.value = "0.001";', js)
        self.assertIn('maximumIterationsInput.value = "100";', js)
